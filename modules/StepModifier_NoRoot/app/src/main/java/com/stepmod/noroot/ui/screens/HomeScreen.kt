...
import com.stepmod.noroot.services.FloatingBallService
import com.stepmod.noroot.utils.ConfigManager
import com.stepmod.noroot.utils.LogEntry
    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth().padding(bottom = 16.dp)) {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(Modifier.height(8.dp))
                Row {
                    StatBox("已修改", counter.longValue.toString(), modifier = Modifier.weight(1f))
