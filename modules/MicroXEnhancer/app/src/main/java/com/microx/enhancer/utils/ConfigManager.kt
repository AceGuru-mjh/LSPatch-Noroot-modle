 ...
 *
 * 保留 KEY_* 常量供旧 Hook 代码（基�?KEY_* + isEnabled）使用，
 * 同时新增 MicroXConfig 高层 API �?Compose UI 使用，二者通过 KEY_* 映射同步�?
 *
...
object ConfigManager {
    ...
    /** 保存全局 MicroXConfig（UI 用）：把高层状态展开为多�?KEY_* */
    ...
    /** �?MicroXConfig 展开为多�?KEY_* 写入 prefs */
