package com.microx.enhancer.activities
...
fun GlassmorphismPanel(onClose: () -> Unit) {
    val cfgState = remember { mutableStateOf<MicroXConfig?>(null) }
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(20.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text("MicroX Enhancer 控制面板", style = MaterialTheme.typography.titleLarge, modifier = Modifier.weight(1f))
    ...
    override fun onDestroy() {
        com.microx.enhancer.services.FloatingBallService.panelOpen = false
        super.onDestroy()
    }
}