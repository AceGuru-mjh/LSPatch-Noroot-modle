...
import com.microx.enhancer.services.FloatingBallService
import com.microx.enhancer.utils.ConfigManager
import com.microx.enhancer.utils.LogEntry
...
@Composable
fun HomeScreen(cfg: MicroXConfig, onConfigChange: (MicroXConfig) -> Unit) {
    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth().padding(bottom = 16.dp)) {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(Modifier.height(8.dp))
                Row {
                    StatBox("已触发", counter.longValue.toString(), modifier = Modifier.weight(1f))
