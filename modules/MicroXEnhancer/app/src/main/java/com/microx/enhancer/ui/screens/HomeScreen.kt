...
fun HomeScreen(
    cfg: MicroXConfig,
    onConfigChange: (MicroXConfig) -> Unit,
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text("MicroX Enhancer", style = MaterialTheme.typography.headlineSmall)
                }
                Text("v${XposedLoader.VERSION}", style = MaterialTheme.typography.bodyMedium)
                Spacer(Modifier.height(8.dp))
                Text(
                    "增强功能触发 ${stats.longValue} 次",
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Row {
                    ...
                    StatBox("MB缓存", "${stats.longValue * 2}", modifier = Modifier.weight(1f))
                }
            }
        }
