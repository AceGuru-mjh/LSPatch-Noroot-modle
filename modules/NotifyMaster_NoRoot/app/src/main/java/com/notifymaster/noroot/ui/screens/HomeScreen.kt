    ...
    Column(
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text("NotifyMaster NoRoot", style = MaterialTheme.typography.headlineSmall)
                }
                Text("v${XposedLoader.VERSION}", style = MaterialTheme.typography.bodyMedium)
                Spacer(Modifier.height(8.dp))
                Text(
                    "通知过滤 ${stats.longValue} 条",
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(Modifier.height(8.dp))
                Row {
                    StatBox("过滤", stats.longValue.toString(), modifier = Modifier.weight(1f))
                    StatBox("条已处理", "${stats.longValue * 3}", modifier = Modifier.weight(1f))
                }
            }
        }
