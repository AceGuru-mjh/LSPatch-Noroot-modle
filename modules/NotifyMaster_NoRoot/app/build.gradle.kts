...
android {
    namespace = "com.notifymaster.noroot"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.notifymaster.noroot"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.14"
...
dependencies {
    ...
    // Shizuku API (compileOnly, 免Root通过adb级Shizuku调用，反射兼容)
