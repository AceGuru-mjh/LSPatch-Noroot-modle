package com.vipunlock.noroot.activities
...
import com.vipunlock.noroot.utils.LogEntry
...
fun GlassmorphismPanel(onClose: () -> Unit) {
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(20.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text("VipUnlocker NoRoot 控制面板", style = MaterialTheme.typography.titleLarge, modifier = Modifier.weight(1f))
    ...
    override fun onDestroy() {
        com.vipunlock.noroot.services.FloatingBallService.panelOpen = false
        super.onDestroy()
    }
}