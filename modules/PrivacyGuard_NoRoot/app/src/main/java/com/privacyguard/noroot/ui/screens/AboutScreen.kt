    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Text("• 权限检查欺骗", style = MaterialTheme.typography.bodySmall)
                Text("• GPS位置伪造", style = MaterialTheme.typography.bodySmall)
                Text("• 传感器数据伪造", style = MaterialTheme.typography.bodySmall)
                Text("• 广告ID屏蔽", style = MaterialTheme.typography.bodySmall)
