...
fun GlassmorphismPanel(onClose: () -> Unit) {
    val cfgState = remember { mutableStateOf<AdBlockConfig?>(null) }
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(20.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text("AdBlockerX NoRoot 控制面板", style = MaterialTheme.typography.titleLarge, modifier = Modifier.weight(1f))
