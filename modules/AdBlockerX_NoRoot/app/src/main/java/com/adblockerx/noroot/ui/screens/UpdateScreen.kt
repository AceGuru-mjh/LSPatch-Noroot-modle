...
import com.adblockerx.noroot.utils.ApkDownloader
import com.adblockerx.noroot.utils.UpdateChecker
    ...
    Column(
        ...
        info?.let { ui ->
            ...
            if (ui.hasUpdate && !ui.isIgnored) {
                Spacer(Modifier.height(12.dp))
                val apk = UpdateChecker.findMatchingApk(ui, "AdBlockerX_NoRoot")
                if (apk != null) {
