...
import com.adblockerx.noroot.utils.LogEntry
    ...
    Column(
        ...
        Card(
            ...
            Column(modifier = Modifier.fillMaxWidth().padding(24.dp)) {
                Icon(Icons.Default.Block, contentDescription = null, tint = MaterialTheme.colorScheme.onPrimaryContainer)
        ...
        Card(modifier = Modifier.fillMaxWidth().padding(bottom = 16.dp)) {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(Modifier.height(8.dp))
                Row {
                    StatBox("已处理", counter.longValue.toString(), modifier = Modifier.weight(1f))
