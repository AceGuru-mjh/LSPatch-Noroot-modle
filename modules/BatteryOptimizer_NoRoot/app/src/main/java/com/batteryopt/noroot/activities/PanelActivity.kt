package com.batteryopt.noroot.activities
...
import com.batteryopt.noroot.utils.LogEntry
...
class PanelActivity : ComponentActivity() {
    ...
    override fun onDestroy() {
        com.batteryopt.noroot.services.FloatingBallService.panelOpen = false
        super.onDestroy()
    }
}
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(20.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text("BatteryOptimizer NoRoot 控制面板", style = MaterialTheme.typography.titleLarge, modifier = Modifier.weight(1f))
