...
import com.batteryopt.noroot.utils.ApkDownloader
import com.batteryopt.noroot.utils.UpdateChecker
    ...
    Column(
        ...
        info?.let { ui ->
            ...
            if (ui.hasUpdate && !ui.isIgnored) {
                Spacer(Modifier.height(12.dp))
                val apk = UpdateChecker.findMatchingApk(ui, "BatteryOptimizer_NoRoot")
                if (apk != null) {
