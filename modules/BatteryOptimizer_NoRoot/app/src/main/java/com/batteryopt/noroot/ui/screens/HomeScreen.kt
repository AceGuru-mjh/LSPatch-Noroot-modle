...
import com.batteryopt.noroot.services.FloatingBallService
    ...
    Column(
        ...
        Card(
            ...
            Column(modifier = Modifier.fillMaxWidth().padding(24.dp)) {
                Icon(Icons.Default.BatteryStd, contentDescription = null, tint = MaterialTheme.colorScheme.onPrimaryContainer)
