...
fun HomeScreen(
    cfg: BatteryConfig,
    onConfigChange: (BatteryConfig) -> Unit,
    ...
    Column(
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text("BatteryOptimizer NoRoot", style = MaterialTheme.typography.headlineSmall)
                }
                Text("v${XposedLoader.VERSION}", style = MaterialTheme.typography.bodyMedium)
                Spacer(Modifier.height(8.dp))
                Text(
                    "已优化 ${stats.longValue} 次",
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(Modifier.height(8.dp))
                Row {
                    StatBox("优化", stats.longValue.toString(), modifier = Modifier.weight(1f))
                    StatBox("mAh节省", "${stats.longValue * 50}", modifier = Modifier.weight(1f))
                }
            }
        }
