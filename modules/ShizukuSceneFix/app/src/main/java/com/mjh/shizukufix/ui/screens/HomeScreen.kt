    ...
    Column(
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text("Shizuku Scene Fix", style = MaterialTheme.typography.headlineSmall)
                }
                Text("v${XposedLoader.VERSION}", style = MaterialTheme.typography.bodyMedium)
                Spacer(Modifier.height(8.dp))
                Text(
                    "已修复 ${stats.longValue} 次授权",
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(Modifier.height(8.dp))
                Row {
                    StatBox("已修复", stats.longValue.toString(), modifier = Modifier.weight(1f))
                    StatBox("授权注入", "${stats.longValue * 3}", modifier = Modifier.weight(1f))
                }
            }
        }
