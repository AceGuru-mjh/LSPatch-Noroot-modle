    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(Modifier.height(8.dp))
                Text("�?修复 Scene �?Shizuku 授权列表不显示问�?, style = MaterialTheme.typography.bodySmall)
                Text("�?Path A: Scene 启动后主动申�?Shizuku 权限", style = MaterialTheme.typography.bodySmall)
                Text("�?Path B: �?Shizuku 列表注入 Scene", style = MaterialTheme.typography.bodySmall)
                Text("�?Shizuku 变体包名检测（兼容第三�?fork�?, style = MaterialTheme.typography.bodySmall)
                Text("�?[实验] Shizuku 服务保活", style = MaterialTheme.typography.bodySmall)
                Text("�?[实验] 授权对话框自动确认辅�?, style = MaterialTheme.typography.bodySmall)
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Text(
                    "仅供学习研究使用。Shizuku 是开源项目，本模块不修改 Shizuku 源码�? +
                        "仅在运行�?Hook 帮助 Scene 出现�?Shizuku 授权列表中�? +
