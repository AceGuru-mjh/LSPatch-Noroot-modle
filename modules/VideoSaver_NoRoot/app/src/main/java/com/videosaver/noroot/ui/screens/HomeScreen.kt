    ...
    Column(
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text("VideoSaver NoRoot", style = MaterialTheme.typography.headlineSmall)
                }
                Text("v${XposedLoader.VERSION}", style = MaterialTheme.typography.bodyMedium)
                Spacer(Modifier.height(8.dp))
                Text(
                    "已保存 ${stats.longValue} 个视频",
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(Modifier.height(8.dp))
                Row {
                    StatBox("保存", stats.longValue.toString(), modifier = Modifier.weight(1f))
                    StatBox("MB已下载", "${stats.longValue * 32}", modifier = Modifier.weight(1f))
                }
            }
        }
