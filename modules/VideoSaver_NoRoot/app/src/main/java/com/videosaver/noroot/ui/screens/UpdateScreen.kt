...
import com.videosaver.noroot.utils.ApkDownloader
import com.videosaver.noroot.utils.UpdateChecker
    ...
    Column(
        ...
        info?.let { ui ->
            ...
            if (ui.hasUpdate && !ui.isIgnored) {
                Spacer(Modifier.height(12.dp))
                val apk = UpdateChecker.findMatchingApk(ui, "VideoSaver_NoRoot")
                if (apk != null) {
