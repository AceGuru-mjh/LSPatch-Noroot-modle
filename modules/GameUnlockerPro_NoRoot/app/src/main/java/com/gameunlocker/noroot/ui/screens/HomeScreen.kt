    ...
    Column(
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text("GameUnlocker NoRoot", style = MaterialTheme.typography.headlineSmall)
                }
                Text("v${XposedLoader.VERSION}", style = MaterialTheme.typography.bodyMedium)
                Spacer(Modifier.height(8.dp))
                Text(
                    "帧率解锁 ${stats.longValue} 次",
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(Modifier.height(8.dp))
                Row {
                    StatBox("帧率", stats.longValue.toString(), modifier = Modifier.weight(1f))
                    StatBox("帧提升", "${stats.longValue * 30}", modifier = Modifier.weight(1f))
                }
            }
        }
