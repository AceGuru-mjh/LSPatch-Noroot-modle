package com.gameunlocker.noroot.activities
...
import com.gameunlocker.noroot.utils.LogEntry
...
class PanelActivity : ComponentActivity() {
    ...
    override fun onDestroy() {
        com.gameunlocker.noroot.services.FloatingBallService.panelOpen = false
        super.onDestroy()
    }
}
...
fun GlassmorphismPanel(onClose: () -> Unit) {
    val cfgState = remember { mutableStateOf<GameConfig?>(null) }
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(20.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text("GameUnlocker NoRoot 控制面板", style = MaterialTheme.typography.titleLarge, modifier = Modifier.weight(1f))
